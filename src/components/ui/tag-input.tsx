    ...
    return (
      ...
      >
        <div
          ...
          dir={dir}
          className={cn(
            "flex items-center flex-wrap gap-1 p-1 rounded-lg overflow-hidden ring-1 ring-input",
            {
        ...
        >
          {value.map((item, index) => (
            <Badge
              ...
              className={cn(
                "relative pl-2 pr-1 rounded flex items-center gap-1 ring-1 ring-input",
              )}
              variant={"secondary"}
            >
              ...
              <button
                ...
                className="p-0 hover:bg-red-400 disabled:cursor-not-allowed"
              >
          ...
          <Input
            ...
            className={cn(
              "h-7 min-w-fit px-1.5 flex-1 placeholder:text-zinc-500 focus-visible:outline-0 focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-0 outline-0 border-none",
